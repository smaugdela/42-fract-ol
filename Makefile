...
#    Updated: 2021/12/17 14:56:24 by smagdela         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
LIBS	:=	${LIBFT} ${MLX}
SRCS	=	fractol.c ft_utils.c ft_data.c ft_draw.c ft_draw_2.c ft_colouring.c ft_events.c ft_events_2.c mandelbrot.c julia.c
BONUS 	=	
